  ...
  Future<void> _loadData() async {
    ...
    if (serviceNo == 1) {
      if (city.isNotEmpty) {
        ...
        final WeatherResponse02? response02 = await API.getForecast(city);
        if (!mounted) return;
        if(response!=null)
          {
            setState(() {
              temp = response.main.temp.toString();
              maxTemp = response.main.tempMax.toString();
              minTemp = response.main.tempMin.toString();
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      _buildSunInfo(sunSet, Icons.nights_stay_outlined),
                    ],
                  ),
                  SizedBox(height: 30.h),
                  Container(
